...
/// ei import ta j kor6i atar data node_module theke as6e 

// basic scratch of our app
    ...
    >
      <img
        ...
        src={
          'https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_264,h_288,c_fill/' +
          cloudinaryImageId
        }   // {} mane amara + use  kor6i tai concatination js er part tai {} e likhe6i
        alt="Biryani"
      />
      ...
      {/*uporer tar bodole niche oi vabe likhbo */}
...
// resList akta array tate sob a6e 
const resList = [
  {
    type: 'restaurant',// type o a6e 
    data: {            // hichrarchical order e data a6e tai data 
      type: 'F',
      id: '121603',
...
const Footer = () => {
  return (
    <footer className="footer">
      <p>
        Copyright &copy; {currYear}, Made with 💗 by <strong>Dip</strong>
      </p>
    </footer>
  );
};
